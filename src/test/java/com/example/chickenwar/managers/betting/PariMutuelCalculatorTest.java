...
class PariMutuelCalculatorTest {
    ...
    void shouldSplitLoserPoolByRatioAndApplyTax() {
        ...
        PariMutuelCalculator.CalculationResult result = PariMutuelCalculator.calculate(winners, 400L, 5.0D, 10.0D);
    ...
    void shouldCapPayoutAndTrackExcessForJackpot() {
        ...
        PariMutuelCalculator.CalculationResult result = PariMutuelCalculator.calculate(winners, 1000L, 0.0D, 5.0D);
    ...
    void shouldApplyTaxOnCappedProfitOnly() {
        ...
        PariMutuelCalculator.CalculationResult result = PariMutuelCalculator.calculate(winners, 1000L, 5.0D, 5.0D);
    ...
    void shouldRoundTaxUpAndProfitDownForSafety() {
        ...
        PariMutuelCalculator.CalculationResult result = PariMutuelCalculator.calculate(winners, 101L, 5.0D, 10.0D);
